...
export default function Form({ Seccion, token, setAddShop, setTotal, Total, addShop }) {
    ...
    const handleSubmit = async () => {
        if (!formData.direccion | !formData.user_telefono) {
            return setOpen(true);
        }
        try {
            setLoading(true);
        ...
        <div className="grid">
            <div>
                <form className="form-sale">
                    ...
                    <CFormSelect name="tipo_servicio" value={formData.tipo_servicio}
                    ...
                    <div>
                        ...
                        >
                            ...
                            >
                                <Typography>
                                    <div style={{ display: 'flex', alignContent: 'center', justifyContent: 'center' }}>
                                        <div>
                                            Checkout  de Pago, nequi o daviplata
                                        </div>
                                        <div className="img-checkout-pago">
                                            <div> <img src="/img/daviplata.svg" /></div>
                                            <div> <img src="/img/nequi-2.svg" /></div>
                                        </div>
                                    </div>
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                                    <div>
                                        Para proceder con el pago, consigne el monto total de su compra al número de cuenta: <span style={{
                                            color: '#FF6333'
                                        }}>311533906 </span> su monto total es: <span style={{
                                            color: '#FF6333'
                                        }}>${valueToDisplay}</span>
                                    </div>
                                    <div>
                                        Puedes hacer tu transferencia a través de nuestros dos métodos de pago, toma captura del pago y súbelo en este recuadro¡!
                                    </div>
                                    <div>
                        ...
                        >
                            ...
                            <AccordionDetails>
                                <Typography>
                                    Paga en efectivo cuando entreguemos tu pedido en el domicilio seleccionado (sólo para entregas, tu total es: ${valueToDisplay})
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                    </div>
